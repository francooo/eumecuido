...
export default function LogDoseScreen() {
  return (
    <div className="bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center p-0 sm:p-4">
      {/* Mobile Container */}
      <div className="w-full max-w-md bg-white dark:bg-[#152a25] min-h-screen sm:min-h-[800px] sm:h-auto sm:rounded-[3rem] shadow-2xl flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar px-6 pb-32">
          ...
          <div className="bg-background-light dark:bg-background-dark rounded-[2rem] p-6 mb-8 flex items-center gap-4 shadow-soft">
            <div className="w-16 h-16 rounded-full bg-white dark:bg-[#1a332d] flex items-center justify-center shrink-0 shadow-sm relative overflow-hidden">
              <img
                alt="Abstract medicine packaging with soft colors"
                className="w-full h-full object-cover opacity-80"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAsG9P1KQvSFk6dcBF7UwXUAAkDKACw57rH-q_4OU8FQl9wks-A7p0dvWMC17F6LVAXVl3rTngVtEqzeYVXEPfnx0XL7LJ2FoMSJXfSJTJqjB-qwUnB38WgZSKpePfEvHlXFV6UgvvKnapvtfciC6o91nfrl7-gToMJWHT5c27J0HctbEm72OwL1XvBz_3ymz66ixTE60BgUYA9viudHvBr2vpZyVQsIGwOef9AZbq8NW_Pte8_tDwiFjCX3SZM1MJW99zzJym_gtw"
              />
            </div>
          ...
          <div className="mb-10">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex flex-col items-center justify-center min-w-[80px]">
                <span className="text-6xl font-display font-bold text-slate-900 dark:text-slate-100 tracking-tighter">5</span>
                <div className="relative mt-1">
                  <select className="appearance-none bg-transparent border-none text-gentle-sage font-bold text-xl py-0 pl-0 pr-6 focus:ring-0 cursor-pointer">
                    <option value="ml">ml</option>
                    <option value="mg">mg</option>
                    <option value="drops">drops</option>
                  </select>
                  <span className="material-symbols-outlined absolute right-0 top-1/2 -translate-y-1/2 text-gentle-sage text-sm pointer-events-none">expand_more</span>
                </div>
              </div>

              {/* Plus Button */}
              <button className="w-16 h-16 rounded-full bg-primary text-slate-900 flex items-center justify-center shadow-lg shadow-primary/30 transition-all hover:scale-105 active:scale-95">
                <span className="material-symbols-outlined text-4xl">add</span>
              </button>
            </div>

            {/* Visual Volume Indicator (Slider approximation) */}
            <div className="mt-8 px-4">
              <div className="h-3 bg-background-light dark:bg-background-dark rounded-full w-full relative overflow-hidden">
          ...
          <div className="mb-8">
            ...
            <div className="bg-primary/10 dark:bg-primary/5 rounded-[2rem] p-5 flex items-center justify-between border border-primary/20 transition-all active:scale-[0.99]">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white dark:bg-[#1a332d] flex items-center justify-center text-primary shadow-sm">
