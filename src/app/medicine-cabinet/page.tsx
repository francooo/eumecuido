    ...
    <div className="bg-background-light dark:bg-background-dark text-text-main dark:text-slate-100 min-h-screen flex flex-col items-center justify-start overflow-x-hidden selection:bg-primary/30">
      <div className="relative w-full max-w-md mx-auto min-h-screen flex flex-col bg-background-light dark:bg-background-dark shadow-2xl overflow-hidden">
        ...
        <header className="flex items-center justify-between px-6 pt-8 pb-4 bg-background-light dark:bg-surface-dark sticky top-0 z-20 backdrop-blur-sm bg-opacity-95 dark:bg-opacity-95">
          ...
          <h1 className="text-lg font-bold text-text-main dark:text-white tracking-tight">Adicionar Medicamento</h1>
        ...
        <main className="flex-1 px-6 pb-24 overflow-y-auto">
          ...
          <div className="mb-6 flex items-center justify-center">
            <div className="inline-flex items-center gap-2 bg-mint-soft dark:bg-white/5 px-4 py-2 rounded-full border border-primary/10">
              ...
              <p className="text-sm font-medium text-text-main dark:text-slate-200">
                Adicionando para <span className="font-bold">Leo</span> <span className="text-text-muted dark:text-slate-400 text-xs ml-1">(14kg)</span>
              </p>
            </div>
          </div>
          ...
          <section className="mb-8 group">
            <div className="relative w-full aspect-[4/3] bg-mint-soft dark:bg-surface-dark rounded-2xl border-2 border-dashed border-primary/40 hover:border-primary transition-all cursor-pointer overflow-hidden flex flex-col items-center justify-center text-center p-6 shadow-sm hover:shadow-soft active:scale-[0.99]">
              ...
              <div className="z-10 flex flex-col items-center gap-3 transition-transform duration-300 group-hover:-translate-y-1">
                ...
                <div>
                  <h3 className="text-text-main dark:text-white font-bold text-lg">Escanear Rótulo</h3>
                  <p className="text-text-muted text-sm mt-1 max-w-[200px] mx-auto leading-relaxed">Tire uma foto da caixa para preencher os detalhes automaticamente.</p>
                </div>
                ...
                <p className="text-[10px] text-primary-dark dark:text-primary/70 font-medium mt-1 uppercase tracking-tight">IA detectará as unidades automaticamente</p>
              </div>
          ...
          <section className="flex flex-col gap-6">
            {/* Name Input */}
            <div className="group">
              <label className="block text-xs font-bold text-text-muted uppercase tracking-widest mb-2 pl-4">Nome do Medicamento</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-text-muted group-focus-within:text-primary transition-colors">
                  <span className="material-symbols-outlined">medication</span>
                </div>
                <input className="input-soft w-full bg-white dark:bg-surface-dark text-text-main dark:text-white placeholder-gray-300 dark:placeholder-gray-600 font-bold text-lg rounded-2xl border-0 py-4 pl-12 pr-4 shadow-sm ring-1 ring-slate-100 dark:ring-white/10 transition-all" placeholder="ex. Ibuprofeno" type="text" />
              </div>
            </div>

            {/* Type Toggle */}
            <div>
              <label className="block text-xs font-bold text-text-muted uppercase tracking-widest mb-3 pl-4">Tipo</label>
              <div className="flex p-1 bg-white dark:bg-surface-dark rounded-full shadow-sm ring-1 ring-slate-100 dark:ring-white/10 relative isolate">
                ...
                <label className="flex-1 cursor-pointer">
                  ...
                  <div className="flex items-center justify-center gap-2 py-3 px-2 rounded-full transition-all peer-checked:bg-primary peer-checked:text-slate-900 peer-checked:font-bold text-text-muted hover:bg-gray-50 dark:hover:bg-white/5">
                    ...
                    <span className="text-sm">Comprimido</span>
                  </div>
                </label>
            ...
            {/* Strength Input */}
            <div className="group">
              <label className="block text-xs font-bold text-text-muted uppercase tracking-widest mb-2 pl-4">Dosagem / Concentração</label>
              <div className="relative">
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <input className="input-soft w-full bg-white dark:bg-surface-dark text-text-main dark:text-white placeholder-gray-300 dark:placeholder-gray-600 font-medium text-lg rounded-2xl border-0 py-4 pl-12 pr-4 shadow-sm ring-1 ring-slate-100 dark:ring-white/10 transition-all" placeholder="ex. 100" step="any" type="number" />
                  </div>
              ...
              <p className="text-xs text-text-muted mt-2 pl-4">Insira o valor numérico e selecione a unidade (ml, mg, gotas). A IA detecta isso nos rótulos.</p>
            </div>

            {/* Notes Input */}
            <div className="group">
              <label className="block text-xs font-bold text-text-muted uppercase tracking-widest mb-2 pl-4">Instruções / Observações</label>
              <textarea className="input-soft w-full bg-white dark:bg-surface-dark text-text-main dark:text-white placeholder-gray-300 dark:placeholder-gray-600 font-normal text-base rounded-2xl border-0 py-4 px-4 shadow-sm ring-1 ring-slate-100 dark:ring-white/10 resize-none transition-all" placeholder="Tomar com comida, manter refrigerado..." rows={3}></textarea>
            </div>
          </section>
        </main>
        ...
        <nav className="sticky bottom-0 z-30 w-full bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-lg border-t border-[#e7f3f0] dark:border-white/5 pb-5 pt-3 px-6">
          <div className="flex justify-between items-center gap-4">
            ...
            <a className="flex flex-col items-center gap-1 text-primary" href="#">
              ...
              <span className="text-[10px] font-bold">Medicamentos</span>
            </a>
            ...
            <a className="flex flex-col items-center gap-1 opacity-50 hover:opacity-100 transition-opacity" href="#">
              ...
              <span className="text-[10px] font-bold text-text-main dark:text-white">Registrar</span>
            </a>
            <a className="flex flex-col items-center gap-1 opacity-50 hover:opacity-100 transition-opacity" href="#">
              <span className="material-symbols-outlined text-text-main dark:text-white text-[24px]">history</span>
              <span className="text-[10px] font-bold text-text-main dark:text-white">Histórico</span>
            </a>
          </div>
        </nav>
      </div>
